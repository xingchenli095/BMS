...
CanIf_CheckTrcvWakeFlagIndication/17 (CanIf_CheckTrcvWakeFlagIndication) @06d6cd20
  Type: function
  ...
  Calls: 
CanIf_ClearTrcvWufFlagIndication/16 (CanIf_ClearTrcvWufFlagIndication) @06d6cb60
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
CanIf_ConfirmPnAvailability/15 (CanIf_ConfirmPnAvailability) @06d6c700
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
CanIf_TrcvModeIndication/14 (CanIf_TrcvModeIndication) @06d6c620
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
CanTrcv_CheckWakeup/13 (CanTrcv_CheckWakeup) @06d6c2a0
  ...
  Called by: 
  Calls: 
CanTrcv_CheckWakeFlag/12 (CanTrcv_CheckWakeFlag) @06d6c0e0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: CanTrcv_IsInit/1 (read)CanTrcv_WakeFlag/2 (read)CanTrcv_TrcvWakeupMode/4 (read)
  Referring: 
...
CanTrcv_ClearTrcvWufFlag/11 (CanTrcv_ClearTrcvWufFlag) @06d64ee0
  Type: function definition analyzed
  Visibility: externally_visible public
...
CanTrcv_SetWakeupMode/10 (CanTrcv_SetWakeupMode) @06d64d20
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: 
CanTrcv_GetBusWuReason/9 (CanTrcv_GetBusWuReason) @06d64b60
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: 
CanTrcv_GetOpMode/8 (CanTrcv_GetOpMode) @06d649a0
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: 
CanTrcv_SetOpMode/7 (CanTrcv_SetOpMode) @06d647e0
  Type: function definition analyzed
  Visibility: externally_visible public
...
CanTrcv_MainFunction/6 (CanTrcv_MainFunction) @06d64620
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
CanTrcv_Init/5 (CanTrcv_Init) @06d64460
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: 
CanTrcv_TrcvWakeupMode/4 (CanTrcv_TrcvWakeupMode) @06cdddc8
...
CanTrcv_TrcvMode/3 (CanTrcv_TrcvMode) @06cddd80
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  ...
  Availability: available
  Varpool flags: initialized
CanTrcv_WakeFlag/2 (CanTrcv_WakeFlag) @06cddd38
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  ...
  Availability: available
  Varpool flags: initialized
CanTrcv_IsInit/1 (CanTrcv_IsInit) @06cddcf0
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  ...
  Availability: available
  Varpool flags: initialized
CanTrcv_WUReason/0 (CanTrcv_WUReason) @06cddca8
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
