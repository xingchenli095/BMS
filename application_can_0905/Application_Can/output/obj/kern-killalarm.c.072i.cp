...
OS_svc_KillAlarm/7 (OS_svc_KillAlarm) @06c64f30
  Type: variable
...
OS_Error/6 (OS_Error) @06d3b1c0
  ...
  Calls: 
OS_totalAlarms/5 (OS_totalAlarms) @06c64e10
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_CORTEXM_IntSetDisablingLevel/4 (OS_CORTEXM_IntSetDisablingLevel) @06d3b000
  ...
  Calls: 
OS_kernDisableLevel/3 (OS_kernDisableLevel) @06c64d80
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_counterTableBase/2 (OS_counterTableBase) @06c64d38
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_alarmTableBase/1 (OS_alarmTableBase) @06c64cf0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
