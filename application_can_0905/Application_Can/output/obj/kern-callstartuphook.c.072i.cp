...
OS_CORTEXM_Call/10 (OS_CORTEXM_Call) @06ce71c0
  Type: function
  ...
  Calls: 
OS_SetHookProtection/9 (OS_SetHookProtection) @06ce70e0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Called by: OS_CallStartupHook/0 (418168753 (estimated locally),0.39 per call) 
  Calls: 
OS_sHookStackLen/8 (OS_sHookStackLen) @06ce8000
  Type: variable
...
OS_sHookMpuSize/7 (OS_sHookMpuSize) @06c04f78
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_CORTEXM_IntSetDisablingLevel/6 (OS_CORTEXM_IntSetDisablingLevel) @06ce7000
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_kernDisableLevel/5 (OS_kernDisableLevel) @06c04e58
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_svc_HookHandler/4 (OS_svc_HookHandler) @06c04e10
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/3 (OS_Error) @06c29ee0
  ...
  Calls: 
OS_configMode/2 (OS_configMode) @06c04d80
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06c04d38
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_CallStartupHook/0 (OS_CallStartupHook) @06c29d20
