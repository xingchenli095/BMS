...
NvM_StateMachine_SetNextRequest.part.0/28 (NvM_StateMachine_SetNextRequest.part.0) @06e5ae00
...
NvM_PreService_Function/27 (NvM_PreService_Function) @071a01c0
  Type: function
  ...
  Calls: 
NvM_MirrorRetryCount/26 (NvM_MirrorRetryCount) @07208a20
  Type: variable
  ...
  Availability: not_available
  Varpool flags:
NvM_SetRamBlockStatus_Async_CalcCrc_Start/25 (NvM_SetRamBlockStatus_Async_CalcCrc_Start) @071a0e00
  Type: function
  Visibility: external public
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
NvM_CalcCrc_PeekElement/24 (NvM_CalcCrc_PeekElement) @071a0d20
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
NvM_RamBlockCrcCalcCount/23 (NvM_RamBlockCrcCalcCount) @07208990
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
SchM_Exit_NvM_SCHM_NVM_EXCLUSIVE_AREA_0/22 (SchM_Exit_NvM_SCHM_NVM_EXCLUSIVE_AREA_0) @071a0c40
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
NvM_TempRamBlockAddress/21 (NvM_TempRamBlockAddress) @07208900
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
NvM_CurrentServiceId/20 (NvM_CurrentServiceId) @072088b8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
NvM_Queue_Standard/19 (NvM_Queue_Standard) @07208870
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
NvM_Queue_IndexStandard/18 (NvM_Queue_IndexStandard) @07208828
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
SchM_Enter_NvM_SCHM_NVM_EXCLUSIVE_AREA_0/17 (SchM_Enter_NvM_SCHM_NVM_EXCLUSIVE_AREA_0) @071a0a80
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Called by: NvM_ProcessStandardPriorityJob/7 (1073741824 (estimated locally),1.00 per call) NvM_StateMachine_SetNextRequest/6 (1073741823 (estimated locally),1.00 per call) NvM_StateMachine_SetNextRequest.part.0/28 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
NvM_SetPermanentRamBlockUnchanged/16 (NvM_SetPermanentRamBlockUnchanged) @071a08c0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Fee_GetJobResult/15 (Fee_GetJobResult) @071a07e0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
NvM_GlobalErrorStatus/14 (NvM_GlobalErrorStatus) @070bda68
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
NvM_ResetRedundantBlockDataIndex/13 (NvM_ResetRedundantBlockDataIndex) @071a0380
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
NvM_GlobalBlockNumber/12 (NvM_GlobalBlockNumber) @070bd750
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
NvM_CurrentBlockDescriptorPtr/11 (NvM_CurrentBlockDescriptorPtr) @070bd708
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
NvM_AdminBlockTable/10 (NvM_AdminBlockTable) @070bd6c0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
NvM_CurrentFunctionPtr/9 (NvM_CurrentFunctionPtr) @070bd678
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
NvM_GlobalCallLevel/8 (NvM_GlobalCallLevel) @070bd630
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
NvM_ProcessStandardPriorityJob/7 (NvM_ProcessStandardPriorityJob) @071a0000
  Type: function definition analyzed
...
NvM_StateMachine_SetNextRequest/6 (NvM_StateMachine_SetNextRequest) @071b2460
  Type: function definition analyzed
  Visibility: externally_visible public
...
NvM_StateMachine_ProcessJobResult/5 (NvM_StateMachine_ProcessJobResult) @071b20e0
  Type: function definition analyzed
  Visibility: externally_visible public
...
NvM_StateMachine_TerminateSubLevel/4 (NvM_StateMachine_TerminateSubLevel) @071b2d20
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: 
NvM_StateMachine_TerminateCurrentLevel/3 (NvM_StateMachine_TerminateCurrentLevel) @071b2b60
  Type: function definition analyzed
  Visibility: externally_visible public
  References: NvM_GlobalCallLevel/8 (read)NvM_GlobalCallLevel/8 (write)
  Referring: 
  ...
  Calls: 
NvM_StateMachine_RedundantBlockError/2 (NvM_StateMachine_RedundantBlockError) @071b29a0
  Type: function definition analyzed
  Visibility: externally_visible public
...
NvM_StateMachine_ProcessRedundantBlock/1 (NvM_StateMachine_ProcessRedundantBlock) @071b2700
  Type: function definition analyzed
  Visibility: externally_visible public
...
;; Function NvM_StateMachine_ProcessRedundantBlock (NvM_StateMachine_ProcessRedundantBlock, funcdef_no=0, decl_uid=10905, cgraph_uid=2, symbol_order=1)
...
;; Function NvM_StateMachine_TerminateCurrentLevel (NvM_StateMachine_TerminateCurrentLevel, funcdef_no=2, decl_uid=10909, cgraph_uid=4, symbol_order=3)
...
;; Function NvM_StateMachine_RedundantBlockError (NvM_StateMachine_RedundantBlockError, funcdef_no=1, decl_uid=10907, cgraph_uid=3, symbol_order=2)
...
;; Function NvM_StateMachine_TerminateSubLevel (NvM_StateMachine_TerminateSubLevel, funcdef_no=3, decl_uid=10911, cgraph_uid=5, symbol_order=4)
...
;; Function NvM_StateMachine_ProcessJobResult (NvM_StateMachine_ProcessJobResult, funcdef_no=4, decl_uid=10903, cgraph_uid=6, symbol_order=5)
...
;; Function NvM_StateMachine_SetNextRequest (NvM_StateMachine_SetNextRequest, funcdef_no=5, decl_uid=10901, cgraph_uid=7, symbol_order=6)
...
;; Function NvM_ProcessStandardPriorityJob (NvM_ProcessStandardPriorityJob, funcdef_no=6, decl_uid=10736, cgraph_uid=8, symbol_order=7)
