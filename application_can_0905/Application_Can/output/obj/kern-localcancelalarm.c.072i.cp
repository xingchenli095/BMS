...
OS_KillAlarm/4 (OS_KillAlarm) @06c1ae00
  Type: function
  ...
  Calls: 
OS_AppIsAccessible/3 (OS_AppIsAccessible) @06c1ad20
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_CORTEXM_IntSetDisablingLevel/2 (OS_CORTEXM_IntSetDisablingLevel) @06c1ac40
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_kernDisableLevel/1 (OS_kernDisableLevel) @06bfa7e0
  Type: variable
...
OS_LocalCancelAlarm/0 (OS_LocalCancelAlarm) @06c1aa80
