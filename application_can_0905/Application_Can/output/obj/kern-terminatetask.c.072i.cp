...
Jump functions:
  Jump functions of caller  OS_DoTerminateTask/5:
  Jump functions of caller  OS_Error/3:
  Jump functions of caller  OS_KernTerminateTask/0:

 Propagating constants:

Not considering OS_KernTerminateTask for cloning; -fipa-cp-clone disabled.
...
;; Function OS_KernTerminateTask (OS_KernTerminateTask, funcdef_no=0, decl_uid=7192, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_KernTerminateTask/0
