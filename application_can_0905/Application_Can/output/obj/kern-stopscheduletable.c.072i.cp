...
Jump functions:
  Jump functions of caller  OS_LocalStopScheduleTable/9:
  Jump functions of caller  OS_Error/3:
  Jump functions of caller  OS_KernStopScheduleTable/0:

 Propagating constants:

Not considering OS_KernStopScheduleTable for cloning; -fipa-cp-clone disabled.
...
Lattices:
  Node: OS_KernStopScheduleTable/0:
    param [0]: BOTTOM
         ctxs: BOTTOM
...
OS_LocalStopScheduleTable/9 (OS_LocalStopScheduleTable) @06d9a7e0
  Type: function
  ...
  Calls: 
OS_scheduleTableBase/8 (OS_scheduleTableBase) @06dcb510
  Type: variable
...
OS_isrTableBase/7 (OS_isrTableBase) @06dcb4c8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_nSchedules/6 (OS_nSchedules) @06dcb438
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_iecMode/5 (OS_iecMode) @06dcb3a8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_svc_StopScheduleTable/4 (OS_svc_StopScheduleTable) @06dcb360
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/3 (OS_Error) @06d9a700
  ...
  Calls: 
OS_permittedContext/2 (OS_permittedContext) @06dcb2d0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06dcb288
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_KernStopScheduleTable/0 (OS_KernStopScheduleTable) @06d9a2a0
...
;; Function OS_KernStopScheduleTable (OS_KernStopScheduleTable, funcdef_no=0, decl_uid=7303, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_KernStopScheduleTable/0
