...
Jump functions:
  ...
  Jump functions of caller  OS_KernGetElapsedCounterValue/0:

 Propagating constants:

Not considering OS_KernGetElapsedCounterValue for cloning; -fipa-cp-clone disabled.
...
Lattices:
  Node: OS_KernGetElapsedCounterValue/0:
    param [0]: BOTTOM
         ctxs: BOTTOM
...
;; Function OS_KernGetElapsedCounterValue (OS_KernGetElapsedCounterValue, funcdef_no=0, decl_uid=7318, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_KernGetElapsedCounterValue/0
