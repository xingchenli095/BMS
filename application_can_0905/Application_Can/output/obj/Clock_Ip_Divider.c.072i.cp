...
Jump functions:
  ...
  Jump functions of caller  Clock_Ip_SetFircDivSelHseBConfigRegGpr/4:
...
Not considering Clock_Ip_SetFircDivSelHseBConfigRegGpr for cloning; -fipa-cp-clone disabled.
Not considering Clock_Ip_SetPllPlldvOdiv2Output for cloning; -fipa-cp-clone disabled.
Not considering Clock_Ip_SetPllPll0divDeDivOutput for cloning; -fipa-cp-clone disabled.
Not considering Clock_Ip_SetCgmXDeDivStatWithoutPhase for cloning; -fipa-cp-clone disabled.
Not considering Clock_Ip_Callback_DividerEmpty for cloning; -fipa-cp-clone disabled.
...
Lattices:
  Node: Clock_Ip_SetFircDivSelHseBConfigRegGpr/4:
    param [0]: BOTTOM
         ctxs: BOTTOM
...
Clock_Ip_ReportClockErrors/12 (Clock_Ip_ReportClockErrors) @06f88540
  ...
  Calls: 
Clock_Ip_apxCgm/11 (Clock_Ip_apxCgm) @06f82dc8
  Type: variable
...
Clock_Ip_axFeatureExtensions/10 (Clock_Ip_axFeatureExtensions) @06f82d80
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_pxPll/9 (Clock_Ip_pxPll) @06f82798
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_au8ClockFeatures/8 (Clock_Ip_au8ClockFeatures) @06f82750
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
Clock_Ip_TimeoutExpired/7 (Clock_Ip_TimeoutExpired) @06f88000
  ...
  Calls: 
Clock_Ip_StartTimeout/6 (Clock_Ip_StartTimeout) @06f778c0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_axDividerCallbacks/5 (Clock_Ip_axDividerCallbacks) @06f82090
...
Clock_Ip_SetFircDivSelHseBConfigRegGpr/4 (Clock_Ip_SetFircDivSelHseBConfigRegGpr) @06f78e00
...
Clock_Ip_SetPllPlldvOdiv2Output/3 (Clock_Ip_SetPllPlldvOdiv2Output) @06f78b60
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  ...
  Called by: 
  Calls: 
Clock_Ip_SetPllPll0divDeDivOutput/2 (Clock_Ip_SetPllPll0divDeDivOutput) @06f788c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  ...
  Called by: 
  Calls: 
Clock_Ip_SetCgmXDeDivStatWithoutPhase/1 (Clock_Ip_SetCgmXDeDivStatWithoutPhase) @06f78620
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
...
Clock_Ip_Callback_DividerEmpty/0 (Clock_Ip_Callback_DividerEmpty) @06f78460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
Modification phase of node Clock_Ip_SetFircDivSelHseBConfigRegGpr/4
