...
OS_EnqueueAlarm/4 (OS_EnqueueAlarm) @06dac000
  Type: function
  ...
  Calls: 
OS_CORTEXM_IntSetDisablingLevel/3 (OS_CORTEXM_IntSetDisablingLevel) @06cf9000
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_kernDisableLevel/2 (OS_kernDisableLevel) @06cd4e58
  Type: variable
...
OS_AppIsAccessible/1 (OS_AppIsAccessible) @06cf9ee0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_LocalSetAlarm/0 (OS_LocalSetAlarm) @06cf9c40
