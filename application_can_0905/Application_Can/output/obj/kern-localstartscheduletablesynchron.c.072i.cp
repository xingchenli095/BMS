...
OS_AppIsAccessible/4 (OS_AppIsAccessible) @06c0ad20
  Type: function
  ...
  Calls: 
OS_CORTEXM_IntSetDisablingLevel/3 (OS_CORTEXM_IntSetDisablingLevel) @06c0ac40
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_kernDisableLevel/2 (OS_kernDisableLevel) @06be9900
  Type: variable
...
OS_alarmTableBase/1 (OS_alarmTableBase) @06be98b8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_LocalStartScheduleTableSynchron/0 (OS_LocalStartScheduleTableSynchron) @06c0aa80
