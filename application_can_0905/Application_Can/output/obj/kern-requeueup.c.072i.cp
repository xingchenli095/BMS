...
OS_kernelData/3 (OS_kernelData) @06c64bd0
  Type: variable
  ...
  Varpool flags:
OS_taskPtrs/2 (OS_taskPtrs) @06c64b88
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_taskActivations/1 (OS_taskActivations) @06c64b40
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_RequeueUp/0 (OS_RequeueUp) @06c89a80
