...
OS_ShutdownNoHooks/17 (OS_ShutdownNoHooks) @06de3540
  Type: function
...
OS_Panic/16 (OS_Panic) @06de3460
  ...
  Called by: OS_Dispatch/0 (886588624 (estimated locally),0.83 per call) 
  Calls: 
OS_CORTEXM_ContextLoad/15 (OS_CORTEXM_ContextLoad) @06de3380
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_CORTEXM_FPContextLoad/14 (OS_CORTEXM_FPContextLoad) @06de32a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_MissingTerminateTask/13 (OS_MissingTerminateTask) @06de31c0
  Type: function
  Visibility: external public
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
OS_CORTEXM_StartTask/12 (OS_CORTEXM_StartTask) @06de30e0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_startTaskExecTimingFp/11 (OS_startTaskExecTimingFp) @06ddf7e0
  Type: variable
...
OS_SetProtection/10 (OS_SetProtection) @06de3000
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_ptrPreTaskHook/9 (OS_ptrPreTaskHook) @06ddf6c0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_CORTEXM_Idle/8 (OS_CORTEXM_Idle) @06d0fee0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_preemptTaskExecTimingFp/7 (OS_preemptTaskExecTimingFp) @06ddf5a0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_ptrPostTaskHook/6 (OS_ptrPostTaskHook) @06ddf4c8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_svc_Dispatch/5 (OS_svc_Dispatch) @06ddf480
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/4 (OS_Error) @06d0fc40
  ...
  Calls: 
OS_TaskSpOutOfBounds/3 (OS_TaskSpOutOfBounds) @06d0f000
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_configMode/2 (OS_configMode) @06ddf3a8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06ddf360
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_Dispatch/0 (OS_Dispatch) @06d0fb60
