...
Jump functions:
  Jump functions of caller  OS_CallStartupHook/14:
  ...
  Jump functions of caller  OS_KernStartOs/0:
    indirect simple callsite, calling param -1, offset 0, for stmt OS_ptrStartupHook.6_14 ();
    indirect simple callsite, calling param -1, offset 0, for stmt _13 ();

 Propagating constants:

Not considering OS_KernStartOs for cloning; -fipa-cp-clone disabled.
...
;; Function OS_KernStartOs (OS_KernStartOs, funcdef_no=0, decl_uid=7283, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_KernStartOs/0
