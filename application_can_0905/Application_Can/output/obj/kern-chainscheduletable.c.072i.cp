...
OS_LocalChainScheduleTable/10 (OS_LocalChainScheduleTable) @06cff9a0
  Type: function
  ...
  Calls: 
OS_alarmTableBase/9 (OS_alarmTableBase) @06d34678
  Type: variable
...
OS_scheduleTableBase/8 (OS_scheduleTableBase) @06d345e8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_isrTableBase/7 (OS_isrTableBase) @06d345a0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_nSchedules/6 (OS_nSchedules) @06d34510
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_iecMode/5 (OS_iecMode) @06d34480
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_svc_ChainScheduleTable/4 (OS_svc_ChainScheduleTable) @06d34438
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/3 (OS_Error) @06cff8c0
  ...
  Calls: 
OS_permittedContext/2 (OS_permittedContext) @06d343a8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06d34360
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_KernChainScheduleTable/0 (OS_KernChainScheduleTable) @06cff460
