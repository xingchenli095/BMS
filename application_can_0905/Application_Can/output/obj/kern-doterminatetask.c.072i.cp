...
OS_Dequeue/6 (OS_Dequeue) @06bafee0
  ...
  Calls: 
OS_ptrPostTaskHook/5 (OS_ptrPostTaskHook) @06c35d80
  Type: variable
...
OS_kernelData/4 (OS_kernelData) @06c35d38
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_stopTaskExecTimingFp/3 (OS_stopTaskExecTimingFp) @06c35c60
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_CORTEXM_IntSetDisablingLevel/2 (OS_CORTEXM_IntSetDisablingLevel) @06bafd20
  ...
  Calls: 
OS_kernDisableLevel/1 (OS_kernDisableLevel) @06c35bd0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
