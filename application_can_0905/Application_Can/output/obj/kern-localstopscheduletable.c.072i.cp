...
Jump functions:
  ...
  Jump functions of caller  OS_LocalStopScheduleTable/0:

 Propagating constants:

Not considering OS_LocalStopScheduleTable for cloning; -fipa-cp-clone disabled.
...
Lattices:
  Node: OS_LocalStopScheduleTable/0:
    param [0]: BOTTOM
         ctxs: BOTTOM
...
;; Function OS_LocalStopScheduleTable (OS_LocalStopScheduleTable, funcdef_no=0, decl_uid=6485, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_LocalStopScheduleTable/0
