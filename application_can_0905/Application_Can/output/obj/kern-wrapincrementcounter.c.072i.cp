...
OS_AdvanceCounter/5 (OS_AdvanceCounter) @06c3bd20
  Type: function
  ...
  Calls: 
OS_CORTEXM_IntSetDisablingLevel/4 (OS_CORTEXM_IntSetDisablingLevel) @06c3bc40
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_kernDisableLevel/3 (OS_kernDisableLevel) @06c1b6c0
  Type: variable
...
OS_counterTableBase/2 (OS_counterTableBase) @06c1b678
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06c1b630
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_WrapIncrementCounter/0 (OS_WrapIncrementCounter) @06c3ba80
