...
Jump functions:
  ...
  Jump functions of caller  OS_KernAllowAccess/0:

 Propagating constants:

Not considering OS_KernAllowAccess for cloning; -fipa-cp-clone disabled.
...
;; Function OS_KernAllowAccess (OS_KernAllowAccess, funcdef_no=0, decl_uid=7323, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_KernAllowAccess/0
