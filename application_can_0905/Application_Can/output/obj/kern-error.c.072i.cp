...
OS_ErrorAction/9 (OS_ErrorAction) @06c90ee0
  Type: function
  ...
  Calls: 
OS_CORTEXM_IntSetDisablingLevel/8 (OS_CORTEXM_IntSetDisablingLevel) @06c90e00
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_ptrProtectionHook/7 (OS_ptrProtectionHook) @06d61a68
  Type: variable
...
OS_CallErrorHook/6 (OS_CallErrorHook) @06c90d20
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_ptrErrorHook/5 (OS_ptrErrorHook) @06d61948
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_IntDisableConditional/4 (OS_IntDisableConditional) @06c90000
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Called by: OS_Error/0 (37904965 (estimated locally),0.33 per call) 
  Calls: 
OS_hookSelection/3 (OS_hookSelection) @06d618b8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_isrTableBase/2 (OS_isrTableBase) @06d61870
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06d61828
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
