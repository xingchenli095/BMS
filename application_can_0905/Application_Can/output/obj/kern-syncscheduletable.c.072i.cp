...
OS_LocalSyncScheduleTable/9 (OS_LocalSyncScheduleTable) @06ce2a80
  Type: function
  ...
  Calls: 
OS_isrTableBase/8 (OS_isrTableBase) @06d19678
  Type: variable
...
OS_scheduleTableBase/7 (OS_scheduleTableBase) @06d19630
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_nSchedules/6 (OS_nSchedules) @06d195a0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_iecMode/5 (OS_iecMode) @06d19510
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_svc_SyncScheduleTable/4 (OS_svc_SyncScheduleTable) @06d194c8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/3 (OS_Error) @06ce29a0
  ...
  Calls: 
OS_permittedContext/2 (OS_permittedContext) @06d19438
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06d193f0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_KernSyncScheduleTable/0 (OS_KernSyncScheduleTable) @06ce2540
