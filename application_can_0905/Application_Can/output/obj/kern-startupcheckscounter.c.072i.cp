...
Jump functions:
  ...
  Jump functions of caller  OS_StartupChecksCounter/0:

 Propagating constants:

Not considering OS_StartupChecksCounter for cloning; -fipa-cp-clone disabled.
...
Lattices:
  Node: OS_StartupChecksCounter/0:
...
OS_nCounters/3 (OS_nCounters) @06d09b88
  Type: variable
...
OS_Panic/2 (OS_Panic) @06d29c40
  ...
  Calls: 
OS_counterTableBase/1 (OS_counterTableBase) @06d09a68
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_StartupChecksCounter/0 (OS_StartupChecksCounter) @06d29a80
...
;; Function OS_StartupChecksCounter (OS_StartupChecksCounter, funcdef_no=0, decl_uid=6509, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_StartupChecksCounter/0
