...
OS_ExceedExecTime/6 (OS_ExceedExecTime) @06cf20e0
  Type: function
  ...
  Calls: 
OS_isrTableBase/5 (OS_isrTableBase) @06c18ee8
  Type: variable
...
OS_AdvanceTimeStampGeneric/4 (OS_AdvanceTimeStampGeneric) @06c3ce00
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_GetTimeUsed/3 (OS_GetTimeUsed) @06c3c000
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Called by: OS_ExecTimerTimestampInterrupt/0 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
OS_executionTimer/2 (OS_executionTimer) @06c18cf0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06c18ca8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_ExecTimerTimestampInterrupt/0 (OS_ExecTimerTimestampInterrupt) @06c3cd20
