...
Jump functions:
  ...
  Jump functions of caller  OS_KernSetEventAsyn/0:

 Propagating constants:

Not considering OS_KernSetEventAsyn for cloning; -fipa-cp-clone disabled.
...
OS_LocalSetEvent/9 (OS_LocalSetEvent) @06ccf9a0
  Type: function
  ...
  Calls: 
OS_isrTableBase/8 (OS_isrTableBase) @06d015e8
  Type: variable
...
OS_taskTableBase/7 (OS_taskTableBase) @06d015a0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_nTasks/6 (OS_nTasks) @06d01510
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_iecMode/5 (OS_iecMode) @06d01480
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_svc_SetEventAsyn/4 (OS_svc_SetEventAsyn) @06d01438
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/3 (OS_Error) @06ccf8c0
  ...
  Calls: 
OS_permittedContext/2 (OS_permittedContext) @06d013a8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06d01360
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_KernSetEventAsyn/0 (OS_KernSetEventAsyn) @06ccf460
...
;; Function OS_KernSetEventAsyn (OS_KernSetEventAsyn, funcdef_no=0, decl_uid=7215, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_KernSetEventAsyn/0
