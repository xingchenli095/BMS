...
OS_AdvanceCounter/4 (OS_AdvanceCounter) @06d480e0
  Type: function
  ...
  Calls: 
OS_AdvanceTimeStampGeneric/3 (OS_AdvanceTimeStampGeneric) @06d48000
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_CORTEXM_IntSetDisablingLevel/2 (OS_CORTEXM_IntSetDisablingLevel) @06bf6000
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_kernDisableLevel/1 (OS_kernDisableLevel) @06c7c900
  Type: variable
...
OS_HwCounterTimestampUpdate/0 (OS_HwCounterTimestampUpdate) @06bf6e00
