...
OS_ExceedExecTime/5 (OS_ExceedExecTime) @06cfe2a0
  Type: function
  ...
  Calls: 
OS_isrTableBase/4 (OS_isrTableBase) @06c2bea0
  Type: variable
...
OS_GetTimeUsed/3 (OS_GetTimeUsed) @06cfe0e0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_executionTimer/2 (OS_executionTimer) @06c2bd80
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06c2bd38
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_StartResLockTiming/0 (OS_StartResLockTiming) @06c4bee0
