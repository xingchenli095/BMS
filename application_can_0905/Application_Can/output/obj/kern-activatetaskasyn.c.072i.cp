...
OS_LocalActivateTask/9 (OS_LocalActivateTask) @06ce07e0
  Type: function
  ...
  Calls: 
OS_isrTableBase/8 (OS_isrTableBase) @06d10510
  Type: variable
...
OS_taskTableBase/7 (OS_taskTableBase) @06d104c8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_nTasks/6 (OS_nTasks) @06d10438
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_iecMode/5 (OS_iecMode) @06d103a8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_svc_ActivateTaskAsyn/4 (OS_svc_ActivateTaskAsyn) @06d10360
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/3 (OS_Error) @06ce0700
  ...
  Calls: 
OS_permittedContext/2 (OS_permittedContext) @06d102d0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06d10288
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_KernActivateTaskAsyn/0 (OS_KernActivateTaskAsyn) @06ce02a0
