...
Jump functions:
  ...
  Jump functions of caller  OS_KernGetActiveApplicationMode/0:

 Propagating constants:

Not considering OS_KernGetActiveApplicationMode for cloning; -fipa-cp-clone disabled.
...
Lattices:
  Node: OS_KernGetActiveApplicationMode/0:
...
OS_appMode/7 (OS_appMode) @06d5c090
  Type: variable
  ...
  Varpool flags:
OS_iecMode/6 (OS_iecMode) @06d5c000
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_svc_GetActiveApplicationMode/5 (OS_svc_GetActiveApplicationMode) @06c4cf78
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/4 (OS_Error) @06d5b0e0
  ...
  Calls: 
OS_configMode/3 (OS_configMode) @06c4cee8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_permittedContext/2 (OS_permittedContext) @06c4cea0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06c4ce58
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  Referring: OS_KernGetActiveApplicationMode/0 (read)OS_KernGetActiveApplicationMode/0 (read)OS_KernGetActiveApplicationMode/0 (read)OS_KernGetActiveApplicationMode/0 (read)
  Availability: not_available
  Varpool flags:
...
;; Function OS_KernGetActiveApplicationMode (OS_KernGetActiveApplicationMode, funcdef_no=0, decl_uid=7292, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_KernGetActiveApplicationMode/0
