...
#ifndef CRYPTO_AL_RSASSAPKCS1V15VRFY_H
#define CRYPTO_AL_RSASSAPKCS1V15VRFY_H
...
Crypto_AL_SIGNATUREVERIFY_RSA_RSASSA_PKCS1_v1_5_Start
(
  uint32                                                       ObjectId,
 ...
 */
extern FUNC(Std_ReturnType, CRYPTO_APPL_CODE)
Crypto_AL_SIGNATUREVERIFY_RSA_RSASSA_PKCS1_v1_5_Update
(
  uint32                                                         ObjectId,
 ...
 */
extern FUNC(Std_ReturnType, CRYPTO_APPL_CODE)
Crypto_AL_SIGNATUREVERIFY_RSA_RSASSA_PKCS1_v1_5_Finish
(
  uint32                                                         ObjectId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_APPL_DATA) Job
);
 ...
 *
 */
extern FUNC(Std_ReturnType, CRYPTO_CODE) Crypto_AL_SIGNATUREVERIFY_RSA_RSASSA_PKCS1_v1_5_Cancel
(
  uint32                                                         ObjectId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_APPL_DATA) Job
);
...
Crypto_AL_SIGNATUREVERIFY_RSA_RSASSA_PKCS1_v1_5_MainFunction
(
...
#endif /* #if(STD_ON == CRYPTO_RSAPKCS_VRFY_ENABLED) */

#endif /* CRYPTO_AL_RSASSAPKCS1V15VRFY_H */
