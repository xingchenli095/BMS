...
#if OS_GENERATION_ID_OS_H!=0xde28d152UL
...
#endif
#if OS_GENERATION_ID_OS_CONF_H!=0xde28d152UL
...
#endif
#if OS_GENERATION_ID_OS_KCONF_H!=0xde28d152UL
...
const os_uint32_t OS_OS_SYSTEM_0GenBuildId = 0xde28d152UL;
