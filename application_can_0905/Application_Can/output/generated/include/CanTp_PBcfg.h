...
typedef struct /* CanTp_ConfigLayoutType */ {
    ...
    VAR( CanTp_RxNPduTableType, TYPEDEF ) RxNPduTable[9];
    VAR( CanTp_RxNSduConfigType, TYPEDEF ) RxNSduConfig[6];
    VAR( CanTp_TxNSduConfigType, TYPEDEF ) TxNSduConfig[3];
    VAR( CanTp_MfCtrConfigType, TYPEDEF ) MfCtrConfig[1];
    VAR( CanTp_TxNPduToTpChannelType, TYPEDEF ) TxNPduToTpChannel[6];
