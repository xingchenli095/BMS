...
#ifndef CRYPTO_RSASSAPSSVERIFY_H
#define CRYPTO_RSASSAPSSVERIFY_H
 ...
 *
 */
extern FUNC(Std_ReturnType, CRYPTO_CODE) Crypto_AL_SIGNATUREVERIFY_RSA_RSASSA_PSS_Helper_SyncSingleCall
(
...
Crypto_AL_SIGNATUREVERIFY_RSA_RSASSA_PSS_Start
(
  uint32                                                       ObjectId,
 ...
 */
extern FUNC(Std_ReturnType, CRYPTO_APPL_CODE)
Crypto_AL_SIGNATUREVERIFY_RSA_RSASSA_PSS_Update
(
  uint32                                                         ObjectId,
 ...
 */
extern FUNC(Std_ReturnType, CRYPTO_APPL_CODE)
Crypto_AL_SIGNATUREVERIFY_RSA_RSASSA_PSS_Finish
(
  uint32                                                         ObjectId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_APPL_DATA) Job
);
 ...
 *
 */
extern FUNC(Std_ReturnType, CRYPTO_CODE) Crypto_AL_SIGNATUREVERIFY_RSA_RSASSA_PSS_Cancel
(
  uint32                                                         ObjectId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_APPL_DATA) Job
);
 ...
 *
 */
extern FUNC(void, CRYPTO_APPL_CODE) Crypto_AL_SIGNATUREVERIFY_RSA_RSASSA_PSS_MainFunction
(
...
#endif /* CRYPTO_RSASSAPSSVERIFY_H */
