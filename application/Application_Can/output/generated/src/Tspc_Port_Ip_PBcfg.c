...
#define TSPC_PORT_IP_AR_RELEASE_MINOR_VERSION_PBCFG_C        4
#define TSPC_PORT_IP_AR_RELEASE_REVISION_VERSION_PBCFG_C     0
#define TSPC_PORT_IP_SW_MAJOR_VERSION_PBCFG_C                2
...
*                                       FILE VERSION CHECKS
==================================================================================================*/
/* Check if Tspc_Port_Ip__PBcfg.c and Tspc_Port_Ip.h are of the same vendor */
#if (TSPC_PORT_IP_VENDOR_ID_PBCFG_C != TSPC_PORT_IP_VENDOR_ID_H)
    #error "Tspc_Port_Ip__PBcfg.c and Tspc_Port_Ip.h have different vendor ids"
#endif
/* Check if Tspc_Port_Ip__PBcfg.c and Tspc_Port_Ip.h are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Tspc_Port_Ip__PBcfg.c and Tspc_Port_Ip.h are different"
#endif
/* Check if Tspc_Port_Ip__PBcfg.c and Tspc_Port_Ip.h are of the same software version */
    ...
    #error "Software Version Numbers of Tspc_Port_Ip__PBcfg.c and Tspc_Port_Ip.h are different"
#endif
