...
const Mcu_DemConfigType Mcu_DemConfig =
{
    ...
    {(uint32)STD_ON, DemConf_DemEventParameter_MCU_E_INVALIDFXOSC_CONFIG},

    /* DEM error reporting MCU_E_CLOCKMUXSWITCH_FAILURE */
    {(uint32)STD_ON, DemConf_DemEventParameter_MCU_E_CLOCKMUXSWITCH_FAILURE},

    /* DEM error reporting MCU_E_CLOCK_FAILURE */
    {(uint32)STD_ON, DemConf_DemEventParameter_MCU_E_CLOCK_FAILURE},
