...
#define DMA_TCD_INSTANCE_COUNT        TCD_INSTANCE_COUNT
...
#define DMA_IP_CFG_DEVICEREGISTERSV3_AR_RELEASE_MINOR_VERSION        4
#define DMA_IP_CFG_DEVICEREGISTERSV3_AR_RELEASE_REVISION_VERSION     0
#define DMA_IP_CFG_DEVICEREGISTERSV3_SW_MAJOR_VERSION                2
#define DMA_IP_CFG_DEVICEREGISTERSV3_SW_MINOR_VERSION                0
#define DMA_IP_CFG_DEVICEREGISTERSV3_SW_PATCH_VERSION                1
...
/  DMAMUX INSTANCES                              /
/-----------------------------------------------*/
#define DMA_IP_DMAMUX_NOF_INST             ((uint32)DMAMUX_INSTANCE_COUNT)

/*-----------------------------------------------/
/  DMAMUX CHANNELS                               /
/-----------------------------------------------*/

    #define DMA_IP_DMAMUX_NOF_CHANNELS         ((uint32)DMAMUX_CHCFG_COUNT)

#define DMA_IP_DMAMUX_REG_INDEX_CONV(x)    ((uint32)(x) ^ 3U)
...
/-----------------------------------------------*/
    ...
    #define DMA_IP_DMAMUX_BASE_ADDR(instIdx) \
            ((uint32)(((instIdx)>0UL) ? \
            (IP_DMAMUX_1_BASE) : (IP_DMAMUX_0_BASE)))
