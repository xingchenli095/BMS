...
typedef struct /* CanIf_CanControllerConfigType */ {
    VAR( uint32, TYPEDEF ) wakeupSourceIn; /* wakeup source (input) */
    VAR( uint32, TYPEDEF ) wakeupSourceOut; /* wakeup source (output and validation) */
    VAR( boolean, TYPEDEF ) pNFilterEnabled; /* partial networking filter support */
...
typedef struct /* CanIf_CanTrcvChnlConfigType */ {
    VAR( uint32, TYPEDEF ) wakeupSourceIn; /* wakeup source (input) */
    VAR( uint32, TYPEDEF ) wakeupSourceOut; /* wakeup source (output) */
...
typedef struct /* CanIf_TxLPduConfigType */ {
    ...
    VAR( uint8, TYPEDEF ) pNFilterFlag; /* partial networking filter flag */
