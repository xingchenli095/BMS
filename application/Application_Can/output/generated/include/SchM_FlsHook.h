#ifndef SCHM_FLSHOOK_H
#define SCHM_FLSHOOK_H
/**
 * \file
 *
 * \brief AUTOSAR Rte
...
/*
 * This file contains Rte hook declarations for the basic software module instance Fls
 *
...
#undef SchM_Schedulable_Fls_MainFunction_Start
extern FUNC(void, RTE_APPL_CODE) SchM_Schedulable_Fls_MainFunction_Start (void);
#else
...
#undef SchM_Schedulable_Fls_MainFunction_Return
extern FUNC(void, RTE_APPL_CODE) SchM_Schedulable_Fls_MainFunction_Return (void);
#else
