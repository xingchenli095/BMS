...
Not considering Tspc_Port_Ip_ConfigureObeGroup for cloning; -fipa-cp-clone disabled.
Not considering Tspc_Port_Ip_EnableObeGroup for cloning; -fipa-cp-clone disabled.
...
SchM_Exit_Port_PORT_EXCLUSIVE_AREA_10/6 (SchM_Exit_Port_PORT_EXCLUSIVE_AREA_10) @070abe00
  Type: function
  ...
  Called by: Tspc_Port_Ip_ConfigureObeGroup/2 (118111601 (estimated locally),1.00 per call) 
  Calls: 
SchM_Enter_Port_PORT_EXCLUSIVE_AREA_10/5 (SchM_Enter_Port_PORT_EXCLUSIVE_AREA_10) @070abd20
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
SchM_Exit_Port_PORT_EXCLUSIVE_AREA_09/4 (SchM_Exit_Port_PORT_EXCLUSIVE_AREA_09) @070abb60
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
SchM_Enter_Port_PORT_EXCLUSIVE_AREA_09/3 (SchM_Enter_Port_PORT_EXCLUSIVE_AREA_09) @070aba80
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Called by: Tspc_Port_Ip_EnableObeGroup/1 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
Tspc_Port_Ip_ConfigureObeGroup/2 (Tspc_Port_Ip_ConfigureObeGroup) @070ab8c0
  ...
  Called by: 
  Calls: SchM_Exit_Port_PORT_EXCLUSIVE_AREA_10/6 (118111601 (estimated locally),1.00 per call) SchM_Enter_Port_PORT_EXCLUSIVE_AREA_10/5 (118111600 (estimated locally),1.00 per call) 
Tspc_Port_Ip_EnableObeGroup/1 (Tspc_Port_Ip_EnableObeGroup) @070ab700
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
;; Function Tspc_Port_Ip_EnableObeGroup (Tspc_Port_Ip_EnableObeGroup, funcdef_no=1, decl_uid=8519, cgraph_uid=2, symbol_order=1)
...
;; Function Tspc_Port_Ip_ConfigureObeGroup (Tspc_Port_Ip_ConfigureObeGroup, funcdef_no=2, decl_uid=8522, cgraph_uid=3, symbol_order=2)
