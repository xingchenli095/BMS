...
OS_DoGetApplicationId/7 (OS_DoGetApplicationId) @06d901c0
  ...
  Calls: 
OS_iecMode/6 (OS_iecMode) @06d91048
  Type: variable
...
OS_svc_GetApplicationId/5 (OS_svc_GetApplicationId) @06d91000
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/4 (OS_Error) @06d900e0
  ...
  Calls: 
OS_configMode/3 (OS_configMode) @06c79f30
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_permittedContext/2 (OS_permittedContext) @06c79ee8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06c79ea0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
