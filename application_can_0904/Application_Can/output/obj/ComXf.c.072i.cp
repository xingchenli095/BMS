...
Com_ComXf_Get_RxSignalGroupSize/6 (Com_ComXf_Get_RxSignalGroupSize) @06b84d20
  Type: function
  ...
  Calls: 
Det_ASR40_ReportError/5 (Det_ASR40_ReportError) @06b849a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Com_InitStatus/4 (Com_InitStatus) @06b405a0
  Type: variable
  ...
  Availability: not_available
  Varpool flags:
ComXf_EB_Inv_CheckInput/3 (ComXf_EB_Inv_CheckInput) @06b847e0
...
ComXf_EB_CheckInput/2 (ComXf_EB_CheckInput) @06b84620
  Type: function definition analyzed
  Visibility: externally_visible public
  References: Com_InitStatus/4 (read)
  Referring: 
...
ComXf_DeInit/1 (ComXf_DeInit) @06b84460
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
ComXf_Init/0 (ComXf_Init) @06b842a0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: Com_InitStatus/4 (read)
  Referring: 
