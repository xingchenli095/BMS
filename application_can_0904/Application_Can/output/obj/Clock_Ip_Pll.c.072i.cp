...
Clock_Ip_StartTimeout/10 (Clock_Ip_StartTimeout) @070117e0
  ...
  Calls: 
Clock_Ip_pxPll/9 (Clock_Ip_pxPll) @06ffd510
  Type: variable
...
Clock_Ip_au8ClockFeatures/8 (Clock_Ip_au8ClockFeatures) @06ffd4c8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_axPllCallbacks/7 (Clock_Ip_axPllCallbacks) @06ffd2d0
