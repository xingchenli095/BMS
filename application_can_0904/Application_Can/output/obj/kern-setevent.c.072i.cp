...
OS_LocalSetEvent/9 (OS_LocalSetEvent) @06cb49a0
  Type: function
  ...
  Calls: 
OS_isrTableBase/8 (OS_isrTableBase) @06ce55e8
  Type: variable
...
OS_taskTableBase/7 (OS_taskTableBase) @06ce55a0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_nTasks/6 (OS_nTasks) @06ce5510
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_iecMode/5 (OS_iecMode) @06ce5480
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_svc_SetEvent/4 (OS_svc_SetEvent) @06ce5438
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/3 (OS_Error) @06cb48c0
  ...
  Calls: 
OS_permittedContext/2 (OS_permittedContext) @06ce53a8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06ce5360
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_KernSetEvent/0 (OS_KernSetEvent) @06cb4460
