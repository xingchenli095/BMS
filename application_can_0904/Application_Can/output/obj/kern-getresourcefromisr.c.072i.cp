...
OS_startResLockTimingFp/8 (OS_startResLockTimingFp) @06c6cc18
  Type: variable
...
OS_CORTEXM_IntSetDisablingLevel/7 (OS_CORTEXM_IntSetDisablingLevel) @06d3b2a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_kernDisableLevel/6 (OS_kernDisableLevel) @06c6cb88
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_svc_GetResource/5 (OS_svc_GetResource) @06c6caf8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/4 (OS_Error) @06d3b0e0
  ...
  Calls: 
OS_isrTableBase/3 (OS_isrTableBase) @06c6ca68
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_resourceTableBase/2 (OS_resourceTableBase) @06c6ca20
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06c6c9d8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_GetResourceFromIsr/0 (OS_GetResourceFromIsr) @06c8c000
