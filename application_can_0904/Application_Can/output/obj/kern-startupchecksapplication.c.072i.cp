...
Jump functions:
  ...
  Jump functions of caller  OS_StartupChecksApplication/0:

 Propagating constants:

Not considering OS_StartupChecksApplication for cloning; -fipa-cp-clone disabled.
...
Lattices:
  Node: OS_StartupChecksApplication/0:
...
;; Function OS_StartupChecksApplication (OS_StartupChecksApplication, funcdef_no=0, decl_uid=6501, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_StartupChecksApplication/0
