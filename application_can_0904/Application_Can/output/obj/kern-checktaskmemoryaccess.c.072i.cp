...
Determining dynamic type for call: a_47 = OS_DoCheckTaskMemoryAccess (t_35(D), ptr_38(D), len_40(D));
  Starting walk at: a_47 = OS_DoCheckTaskMemoryAccess (t_35(D), ptr_38(D), len_40(D));
...
Jump functions:
  ...
  Jump functions of caller  OS_KernCheckTaskMemoryAccess/1:
    callsite  OS_KernCheckTaskMemoryAccess/1 -> OS_DoCheckTaskMemoryAccess/0 : 
       ...
       param 2: PASS THROUGH: 2, op nop_expr
         value: 0x0, mask: 0xffffffff
         Unknown VR
  Jump functions of caller  OS_DoCheckTaskMemoryAccess/0:

 Propagating constants:

Not considering OS_KernCheckTaskMemoryAccess for cloning; -fipa-cp-clone disabled.
...
Lattices:
  Node: OS_KernCheckTaskMemoryAccess/1:
    param [0]: BOTTOM
         ctxs: BOTTOM
    ...
    param [2]: BOTTOM
         ...
         VARYING
        AGGS BOTTOM
  Node: OS_DoCheckTaskMemoryAccess/0:
    param [0]: VARIABLE
         ctxs: VARIABLE
         Bits unusable (BOTTOM)
         VARYING
...
OS_ramLimit/13 (OS_ramLimit) @06d9f000
  Type: variable
...
OS_ramBase/12 (OS_ramBase) @06d97f78
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_romLimit/11 (OS_romLimit) @06d97f30
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_romBase/10 (OS_romBase) @06d97ee8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_taskTableBase/9 (OS_taskTableBase) @06d97ea0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_nTasks/8 (OS_nTasks) @06d97318
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_iecMode/7 (OS_iecMode) @06d97288
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_svc_CheckTaskMemoryAccess/6 (OS_svc_CheckTaskMemoryAccess) @06d97240
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/5 (OS_Error) @06d72ee0
  ...
  Called by: OS_KernCheckTaskMemoryAccess/1 (83685022 (estimated locally),0.08 per call) OS_KernCheckTaskMemoryAccess/1 (52264383 (estimated locally),0.05 per call) OS_KernCheckTaskMemoryAccess/1 (177167401 (estimated locally),0.17 per call) OS_DoCheckTaskMemoryAccess/0 (124017180 (estimated locally),0.12 per call) 
  Calls: 
OS_configMode/4 (OS_configMode) @06d971b0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_permittedContext/3 (OS_permittedContext) @06d97168
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/2 (OS_kernelData) @06d97120
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_KernCheckTaskMemoryAccess/1 (OS_KernCheckTaskMemoryAccess) @06d72a80
  ...
  Called by: 
  Calls: OS_Error/5 (83685022 (estimated locally),0.08 per call) OS_DoCheckTaskMemoryAccess/0 (124903017 (estimated locally),0.12 per call) OS_Error/5 (52264383 (estimated locally),0.05 per call) OS_Error/5 (177167401 (estimated locally),0.17 per call) 
OS_DoCheckTaskMemoryAccess/0 (OS_DoCheckTaskMemoryAccess) @06d72000
  Type: function definition analyzed
  ...
  Called by: OS_KernCheckTaskMemoryAccess/1 (124903017 (estimated locally),0.12 per call) 
  Calls: OS_Error/5 (124017180 (estimated locally),0.12 per call) 
...
Modification phase of node OS_KernCheckTaskMemoryAccess/1
