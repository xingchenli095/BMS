...
Jump functions:
  ...
  Jump functions of caller  OS_LocalActivateTask/3:
  Jump functions of caller  OS_WrapActivateTask/0:

 Propagating constants:

Not considering OS_WrapActivateTask for cloning; -fipa-cp-clone disabled.
...
OS_svc_ActivateTask/5 (OS_svc_ActivateTask) @06bf8798
  Type: variable
...
OS_Error/4 (OS_Error) @06c18e00
  ...
  Calls: 
OS_LocalActivateTask/3 (OS_LocalActivateTask) @06c18d20
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_taskTableBase/2 (OS_taskTableBase) @06bf86c0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06bf8678
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_WrapActivateTask/0 (OS_WrapActivateTask) @06c18b60
...
Modification phase of node OS_WrapActivateTask/0
