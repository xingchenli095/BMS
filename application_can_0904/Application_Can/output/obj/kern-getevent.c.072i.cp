...
Jump functions:
  Jump functions of caller  OS_LocalGetEvent/9:
  Jump functions of caller  OS_CanWrite/8:
  Jump functions of caller  OS_Error/3:
  Jump functions of caller  OS_KernGetEvent/0:

 Propagating constants:

Not considering OS_KernGetEvent for cloning; -fipa-cp-clone disabled.

overall_size: 91, max_new_size: 11001

IPA lattices after all propagation:

Lattices:
  Node: OS_KernGetEvent/0:
    param [0]: BOTTOM
         ctxs: BOTTOM
...
OS_LocalGetEvent/9 (OS_LocalGetEvent) @06df4a80
  Type: function
  ...
  Calls: 
OS_CanWrite/8 (OS_CanWrite) @06df49a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_taskTableBase/7 (OS_taskTableBase) @06e22240
  Type: variable
...
OS_nTasks/6 (OS_nTasks) @06e221b0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_iecMode/5 (OS_iecMode) @06e22120
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_svc_GetEvent/4 (OS_svc_GetEvent) @06e220d8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/3 (OS_Error) @06df48c0
  ...
  Calls: 
OS_permittedContext/2 (OS_permittedContext) @06e22048
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06e22000
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_KernGetEvent/0 (OS_KernGetEvent) @06df4460
...
;; Function OS_KernGetEvent (OS_KernGetEvent, funcdef_no=0, decl_uid=7281, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_KernGetEvent/0
