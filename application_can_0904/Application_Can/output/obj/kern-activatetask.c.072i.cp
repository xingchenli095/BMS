...
Jump functions:
  ...
  Jump functions of caller  OS_KernActivateTask/0:

 Propagating constants:

Not considering OS_KernActivateTask for cloning; -fipa-cp-clone disabled.
...
OS_LocalActivateTask/9 (OS_LocalActivateTask) @06d057e0
  Type: function
  ...
  Called by: OS_KernActivateTask/0 (288452910 (estimated locally),0.27 per call) 
  Calls: 
OS_isrTableBase/8 (OS_isrTableBase) @06d385a0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  Referring: OS_KernActivateTask/0 (read)
  Availability: not_available
  Varpool flags: read-only
OS_taskTableBase/7 (OS_taskTableBase) @06d38558
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_nTasks/6 (OS_nTasks) @06d384c8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_iecMode/5 (OS_iecMode) @06d38438
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_svc_ActivateTask/4 (OS_svc_ActivateTask) @06d383f0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  Referring: OS_KernActivateTask/0 (addr)OS_KernActivateTask/0 (addr)OS_KernActivateTask/0 (addr)OS_KernActivateTask/0 (addr)OS_KernActivateTask/0 (addr)
  Availability: not_available
  Varpool flags: read-only
OS_Error/3 (OS_Error) @06d05700
  Type: function
  Visibility: external public
  References: 
  Referring: 
  Availability: not_available
  Function flags: optimize_size
  Called by: OS_KernActivateTask/0 (95189460 (estimated locally),0.09 per call) OS_KernActivateTask/0 (73049119 (estimated locally),0.07 per call) OS_KernActivateTask/0 (178053238 (estimated locally),0.17 per call) OS_KernActivateTask/0 (179851755 (estimated locally),0.17 per call) OS_KernActivateTask/0 (354334802 (estimated locally),0.33 per call) 
  Calls: 
OS_permittedContext/2 (OS_permittedContext) @06d38360
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  Referring: OS_KernActivateTask/0 (read)OS_KernActivateTask/0 (read)
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06d38318
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  Referring: OS_KernActivateTask/0 (read)OS_KernActivateTask/0 (read)OS_KernActivateTask/0 (read)OS_KernActivateTask/0 (read)OS_KernActivateTask/0 (read)OS_KernActivateTask/0 (read)OS_KernActivateTask/0 (read)
  Availability: not_available
  Varpool flags:
OS_KernActivateTask/0 (OS_KernActivateTask) @06d052a0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: OS_kernelData/1 (read)OS_permittedContext/2 (read)OS_kernelData/1 (read)OS_permittedContext/2 (read)OS_svc_ActivateTask/4 (addr)OS_iecMode/5 (read)OS_kernelData/1 (read)OS_kernelData/1 (read)OS_svc_ActivateTask/4 (addr)OS_nTasks/6 (read)OS_svc_ActivateTask/4 (addr)OS_taskTableBase/7 (read)OS_kernelData/1 (read)OS_isrTableBase/8 (read)OS_kernelData/1 (read)OS_kernelData/1 (read)OS_svc_ActivateTask/4 (addr)OS_svc_ActivateTask/4 (addr)
  Referring: 
...
;; Function OS_KernActivateTask (OS_KernActivateTask, funcdef_no=0, decl_uid=7196, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_KernActivateTask/0
__attribute__((target ("general-regs-only")))
OS_KernActivateTask (os_taskid_t t)
{
  os_errorresult_t e;
  ...
  _4 = MEM[(const os_callermask_t *)OS_permittedContext.2_3 + 44B];
  _39 = _4 & 1024;
  if (_39 != 0)
    goto <bb 4>; [50.00%]
  else
  ...
  _11 = MEM[(const os_callermask_t *)OS_permittedContext.4_10 + 44B];
  _13 = (int) _2;
  _14 = 1 << _13;
  ...
  # DEBUG BEGIN_STMT
  r_60 = OS_Error (&OS_svc_ActivateTask, 12, &p);
  # DEBUG r => r_60
  goto <bb 30>; [100.00%]
  ...
  # DEBUG BEGIN_STMT
  r_46 = OS_Error (&OS_svc_ActivateTask, 55, &p);
  # DEBUG r => r_46
  goto <bb 30>; [100.00%]
  ...
  # DEBUG BEGIN_STMT
  r_58 = OS_Error (&OS_svc_ActivateTask, 2, &p);
  # DEBUG r => r_58
  goto <bb 30>; [100.00%]
  ...
  # DEBUG BEGIN_STMT
  r_52 = OS_Error (&OS_svc_ActivateTask, 37, &p);
  # DEBUG r => r_52
  goto <bb 30>; [100.00%]
  ...
  # DEBUG BEGIN_STMT
  r_56 = OS_Error (&OS_svc_ActivateTask, e_54, &p);
  # DEBUG r => r_56
