...
NvM_Queue_InsertStandard.part.0/15 (NvM_Queue_InsertStandard.part.0) @06e831c0
  ...
  Calls: 
NvM_Queue_CheckFullStandard.part.0/14 (NvM_Queue_CheckFullStandard.part.0) @06e837e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly artificial
...
;; Function Nvm_Queue_CheckEmpty (Nvm_Queue_CheckEmpty, funcdef_no=0, decl_uid=7688, cgraph_uid=1, symbol_order=3)
...
;; Function NvM_Queue_CheckFullStandard (NvM_Queue_CheckFullStandard, funcdef_no=1, decl_uid=7686, cgraph_uid=2, symbol_order=4)
...
;; Function NvM_Queue_InsertStandard (NvM_Queue_InsertStandard, funcdef_no=3, decl_uid=7682, cgraph_uid=4, symbol_order=6)
...
;; Function NvM_Queue_InsertImmediate (NvM_Queue_InsertImmediate, funcdef_no=2, decl_uid=7692, cgraph_uid=3, symbol_order=5)
...
;; Function NvM_Queue_RemoveFirstItem (NvM_Queue_RemoveFirstItem, funcdef_no=4, decl_uid=7684, cgraph_uid=5, symbol_order=7)
