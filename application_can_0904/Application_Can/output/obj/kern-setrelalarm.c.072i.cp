...
Jump functions:
  ...
  Jump functions of caller  OS_KernSetRelAlarm/0:

 Propagating constants:

Not considering OS_KernSetRelAlarm for cloning; -fipa-cp-clone disabled.

overall_size: 132, max_new_size: 11001

IPA lattices after all propagation:

Lattices:
  Node: OS_KernSetRelAlarm/0:
    param [0]: BOTTOM
         ctxs: BOTTOM
...
;; Function OS_KernSetRelAlarm (OS_KernSetRelAlarm, funcdef_no=0, decl_uid=7266, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_KernSetRelAlarm/0
