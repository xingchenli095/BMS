...
Jump functions:
  Jump functions of caller  OS_CanWrite/0:

 Propagating constants:

Not considering OS_CanWrite for cloning; -fipa-cp-clone disabled.

overall_size: 84, max_new_size: 11001
...
OS_isrTableBase/2 (OS_isrTableBase) @06ce84c8
  Type: variable
...
OS_kernelData/1 (OS_kernelData) @06ce8480
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_CanWrite/0 (OS_CanWrite) @06ce1000
...
;; Function OS_CanWrite (OS_CanWrite, funcdef_no=0, decl_uid=6911, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_CanWrite/0
