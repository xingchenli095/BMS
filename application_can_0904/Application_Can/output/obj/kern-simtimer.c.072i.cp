...
OS_isrTableBase/10 (OS_isrTableBase) @06d47480
  Type: variable
...
OS_nInterrupts/9 (OS_nInterrupts) @06d47438
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_ShutdownNoHooks/8 (OS_ShutdownNoHooks) @06d1d540
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_KernSimTimerAdvance/7 (OS_KernSimTimerAdvance) @06d1d0e0
...
OS_SimTimerSetup/6 (OS_SimTimerSetup) @06c69ee0
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: 
OS_SimTimerStop/5 (OS_SimTimerStop) @06c69d20
  Type: function definition analyzed
  ...
  Called by: 
  Calls: 
OS_SimTimerStart/4 (OS_SimTimerStart) @06c69b60
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  ...
  Called by: 
  Calls: 
OS_SimTimerRead/3 (OS_SimTimerRead) @06c699a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  ...
  Called by: 
  Calls: 
OS_SimTimerInit/2 (OS_SimTimerInit) @06c697e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
...
OS_simTimerDriver/1 (OS_simTimerDriver) @06c36480
...
OS_simTimer/0 (OS_simTimer) @06c363f0
  Type: variable definition analyzed
