...
OS_AppIsAccessible/8 (OS_AppIsAccessible) @06d44a80
  Type: function
  ...
  Calls: 
OS_functionTableBase/7 (OS_functionTableBase) @06d85240
  Type: variable
...
OS_nFunctions/6 (OS_nFunctions) @06d851b0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_iecMode/5 (OS_iecMode) @06d85120
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_svc_CallTrustedFunction/4 (OS_svc_CallTrustedFunction) @06d850d8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/3 (OS_Error) @06d449a0
  ...
  Calls: 
OS_permittedContext/2 (OS_permittedContext) @06d85048
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06d85000
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_KernCallTrustedFunction/0 (OS_KernCallTrustedFunction) @06d44540
