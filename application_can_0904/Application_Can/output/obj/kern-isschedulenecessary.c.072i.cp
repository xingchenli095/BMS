...
Jump functions:
  Jump functions of caller  OS_IsScheduleNecessary/0:

 Propagating constants:

Not considering OS_IsScheduleNecessary for cloning; -fipa-cp-clone disabled.
...
OS_taskPtrs/3 (OS_taskPtrs) @06d09120
  Type: variable
...
OS_kernelData/2 (OS_kernelData) @06d090d8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_taskActivations/1 (OS_taskActivations) @06d09090
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_IsScheduleNecessary/0 (OS_IsScheduleNecessary) @06c6ce00
...
;; Function OS_IsScheduleNecessary (OS_IsScheduleNecessary, funcdef_no=0, decl_uid=7572, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_IsScheduleNecessary/0
