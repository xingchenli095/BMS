...
Jump functions:
  ...
  Jump functions of caller  OS_Exception/0:

 Propagating constants:

Not considering OS_Exception for cloning; -fipa-cp-clone disabled.

overall_size: 98, max_new_size: 11001
...
OS_svc_ArchTrapHandler/3 (OS_svc_ArchTrapHandler) @06c07ca8
  Type: variable
...
OS_Error/2 (OS_Error) @06cd87e0
  ...
  Calls: 
OS_kernelData/1 (OS_kernelData) @06c07c18
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_Exception/0 (OS_Exception) @06cd8620
...
;; Function OS_Exception (OS_Exception, funcdef_no=0, decl_uid=7366, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_Exception/0
