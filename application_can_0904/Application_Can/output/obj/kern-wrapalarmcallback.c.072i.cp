...
OS_svc_HookHandler/6 (OS_svc_HookHandler) @06c28900
  Type: variable
...
OS_Error/5 (OS_Error) @06c48e00
  ...
  Calls: 
OS_alarmCallback/4 (OS_alarmCallback) @06c287e0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_CORTEXM_IntSetDisablingLevel/3 (OS_CORTEXM_IntSetDisablingLevel) @06c48c40
  ...
  Calls: 
OS_kernDisableLevel/2 (OS_kernDisableLevel) @06c28750
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06c28708
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
