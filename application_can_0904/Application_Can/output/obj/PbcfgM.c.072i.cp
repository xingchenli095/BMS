...
PbcfgM_IsValidCfgFuncPtr/9 (PbcfgM_IsValidCfgFuncPtr) @06b2e990
  Type: variable
...
PbcfgM_LcfgSignature/8 (PbcfgM_LcfgSignature) @06b2e5a0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
TS_PlatformSigIsValid/7 (TS_PlatformSigIsValid) @06b29620
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Det_ASR40_ReportError/6 (Det_ASR40_ReportError) @06b29380
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
PbcfgM_AreTheModuleConfigsValid/5 (PbcfgM_AreTheModuleConfigsValid) @06b291c0
...
PbcfgM_IsValidConfig/4 (PbcfgM_IsValidConfig) @06b29000
  Type: function definition analyzed
...
PbcfgM_GetConfig/3 (PbcfgM_GetConfig) @06b07e00
  Type: function definition analyzed
  Visibility: externally_visible public
...
PbcfgM_Init/2 (PbcfgM_Init) @06b07c40
  Type: function definition analyzed
  Visibility: externally_visible public
...
PbcfgM_GConfigPtr/1 (PbcfgM_GConfigPtr) @0689e900
...
PbcfgM_InitStatus/0 (PbcfgM_InitStatus) @0689e8b8
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  Referring: PbcfgM_Init/2 (write)PbcfgM_GetConfig/3 (read)
