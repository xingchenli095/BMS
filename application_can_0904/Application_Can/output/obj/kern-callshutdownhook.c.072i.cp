...
Jump functions:
  ...
  Jump functions of caller  OS_CallShutdownHook/0:
    indirect aggregate callsite, calling param 0, offset 64, by reference, for stmt _9 (code_47(D));
...
Not considering OS_CallShutdownHook for cloning; -fipa-cp-clone disabled.
...
;; Function OS_CallShutdownHook (OS_CallShutdownHook, funcdef_no=0, decl_uid=6835, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_CallShutdownHook/0
