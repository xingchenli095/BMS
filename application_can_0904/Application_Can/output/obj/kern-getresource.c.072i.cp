...
OS_GetResourceFromIsr/8 (OS_GetResourceFromIsr) @06d25700
  Type: function
  ...
  Calls: 
OS_GetResourceFromTask/7 (OS_GetResourceFromTask) @06d25620
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_resourceTableBase/6 (OS_resourceTableBase) @06d4c1b0
  Type: variable
...
OS_nResources/5 (OS_nResources) @06d4c120
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_svc_GetResource/4 (OS_svc_GetResource) @06d4c090
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Error/3 (OS_Error) @06d25540
  ...
  Calls: 
OS_permittedContext/2 (OS_permittedContext) @06d4c000
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06c5bf78
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_KernGetResource/0 (OS_KernGetResource) @06d250e0
