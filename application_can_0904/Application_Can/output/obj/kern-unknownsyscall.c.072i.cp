...
Jump functions:
  ...
  Jump functions of caller  OS_KernUnknownSyscall/0:

 Propagating constants:

Not considering OS_KernUnknownSyscall for cloning; -fipa-cp-clone disabled.
...
Modification phase of node OS_KernUnknownSyscall/0
