...
OS_GetTimeUsed/3 (OS_GetTimeUsed) @06c38c40
  Type: function
  ...
  Calls: 
OS_executionTimer/2 (OS_executionTimer) @06c18798
  Type: variable
...
OS_kernelData/1 (OS_kernelData) @06c18750
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_PreemptIsrExecTiming/0 (OS_PreemptIsrExecTiming) @06c38a80
