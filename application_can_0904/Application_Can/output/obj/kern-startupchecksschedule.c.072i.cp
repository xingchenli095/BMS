...
OS_nSchedules/5 (OS_nSchedules) @06d323a8
  Type: variable
...
OS_alarmTableBase/4 (OS_alarmTableBase) @06d321b0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_counterTableBase/3 (OS_counterTableBase) @06d32168
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_Panic/2 (OS_Panic) @06c7ce00
  ...
  Calls: 
OS_scheduleTableBase/1 (OS_scheduleTableBase) @06d32090
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
