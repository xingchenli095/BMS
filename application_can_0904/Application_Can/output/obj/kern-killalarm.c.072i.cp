...
Determining dynamic type for call: _28 (cs_43);
  Starting walk at: _28 (cs_43);
  instance pointer: cs_43  Outer instance pointer: cs_43 offset: 0 (bits) vtbl reference: 
  Function call may change dynamic type:is_46 = OS_CORTEXM_IntSetDisablingLevel (OS_kernDisableLevel.2_8);
...
Jump functions:
  ...
  Jump functions of caller  OS_KillAlarm/0:
    indirect simple callsite, calling param -1, offset 0, for stmt _28 (cs_43);
       param 0: UNKNOWN
...
Not considering OS_KillAlarm for cloning; -fipa-cp-clone disabled.
...
OS_svc_KillAlarm/7 (OS_svc_KillAlarm) @06c0bf30
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  Referring: OS_KillAlarm/0 (addr)
  Availability: not_available
  Varpool flags: read-only
OS_Error/6 (OS_Error) @06ce31c0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_totalAlarms/5 (OS_totalAlarms) @06c0be10
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  Referring: OS_KillAlarm/0 (read)
  Availability: not_available
  Varpool flags: read-only
OS_CORTEXM_IntSetDisablingLevel/4 (OS_CORTEXM_IntSetDisablingLevel) @06ce3000
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_kernDisableLevel/3 (OS_kernDisableLevel) @06c0bd80
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_counterTableBase/2 (OS_counterTableBase) @06c0bd38
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_alarmTableBase/1 (OS_alarmTableBase) @06c0bcf0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_KillAlarm/0 (OS_KillAlarm) @06c2fe00
...
;; Function OS_KillAlarm (OS_KillAlarm, funcdef_no=0, decl_uid=6446, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_KillAlarm/0
