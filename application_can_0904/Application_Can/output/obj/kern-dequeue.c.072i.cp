...
OS_kernelData/3 (OS_kernelData) @06c29900
  Type: variable
  ...
  Varpool flags:
OS_taskPtrs/2 (OS_taskPtrs) @06c298b8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
OS_taskActivations/1 (OS_taskActivations) @06c29870
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_Dequeue/0 (OS_Dequeue) @06c49a80
