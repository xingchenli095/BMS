...
OS_ShutdownNoHooks/5 (OS_ShutdownNoHooks) @06ccf000
  Type: function
...
OS_Panic/4 (OS_Panic) @06ccfe00
  ...
  Calls: 
OS_KillCalledContext/3 (OS_KillCalledContext) @06ccfd20
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_isrTableBase/2 (OS_isrTableBase) @06cabd38
  Type: variable
...
OS_kernelData/1 (OS_kernelData) @06cabcf0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_KernReturnFromCall/0 (OS_KernReturnFromCall) @06ccfa80
