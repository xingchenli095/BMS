...
OS_DoControlIdle/5 (OS_DoControlIdle) @06cd9460
  Type: function
  ...
  Calls: 
OS_svc_ControlIdle/4 (OS_svc_ControlIdle) @06c04bd0
  Type: variable
...
OS_Error/3 (OS_Error) @06cd9380
  ...
  Calls: 
OS_permittedContext/2 (OS_permittedContext) @06c04b40
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06c04af8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_KernControlIdle/0 (OS_KernControlIdle) @06cd90e0
