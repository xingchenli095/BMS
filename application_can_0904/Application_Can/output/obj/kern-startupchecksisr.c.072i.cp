...
Jump functions:
  ...
  Jump functions of caller  OS_StartupChecksIsr/0:

 Propagating constants:

Not considering OS_StartupChecksIsr for cloning; -fipa-cp-clone disabled.
...
OS_nInterrupts/3 (OS_nInterrupts) @06c19d38
  Type: variable
...
OS_Panic/2 (OS_Panic) @06c3cd20
  ...
  Calls: 
OS_isrTableBase/1 (OS_isrTableBase) @06c19bd0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_StartupChecksIsr/0 (OS_StartupChecksIsr) @06c3ca80
...
;; Function OS_StartupChecksIsr (OS_StartupChecksIsr, funcdef_no=0, decl_uid=6519, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_StartupChecksIsr/0
