...
OS_ExceedExecTime/5 (OS_ExceedExecTime) @06c58000
  Type: function
  ...
  Calls: 
OS_GetTimeUsed/4 (OS_GetTimeUsed) @06c58e00
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_executionTimer/3 (OS_executionTimer) @06c38c60
  Type: variable
...
OS_isrTableBase/2 (OS_isrTableBase) @06c38c18
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06c38bd0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_StopIsrIntLockTiming/0 (OS_StopIsrIntLockTiming) @06c58c40
