...
OS_svc_SetEvent/5 (OS_svc_SetEvent) @06bea828
  Type: variable
...
OS_Error/4 (OS_Error) @06c0e000
  ...
  Calls: 
OS_LocalSetEvent/3 (OS_LocalSetEvent) @06c0eee0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
OS_taskTableBase/2 (OS_taskTableBase) @06bea750
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06bea708
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
OS_WrapSetEvent/0 (OS_WrapSetEvent) @06c0ed20
