...
Jump functions:
  ...
  Jump functions of caller  OS_KernGetIsrId/0:

 Propagating constants:

Not considering OS_KernGetIsrId for cloning; -fipa-cp-clone disabled.
...
OS_iecMode/6 (OS_iecMode) @06d1a090
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  Referring: OS_KernGetIsrId/0 (read)
  Availability: not_available
  Varpool flags: read-only
OS_svc_GetIsrId/5 (OS_svc_GetIsrId) @06d1a048
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  Referring: OS_KernGetIsrId/0 (addr)OS_KernGetIsrId/0 (addr)
  Availability: not_available
  Varpool flags: read-only
OS_Error/4 (OS_Error) @06d190e0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Called by: OS_KernGetIsrId/0 (52264383 (estimated locally),0.05 per call) OS_KernGetIsrId/0 (177167401 (estimated locally),0.17 per call) 
  Calls: 
OS_configMode/3 (OS_configMode) @06c03f78
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  Referring: OS_KernGetIsrId/0 (read)OS_KernGetIsrId/0 (read)
  Availability: not_available
  Varpool flags: read-only
OS_permittedContext/2 (OS_permittedContext) @06c03f30
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_kernelData/1 (OS_kernelData) @06c03ee8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  Referring: OS_KernGetIsrId/0 (read)OS_KernGetIsrId/0 (read)OS_KernGetIsrId/0 (read)OS_KernGetIsrId/0 (read)OS_KernGetIsrId/0 (read)
  Availability: not_available
  Varpool flags:
OS_KernGetIsrId/0 (OS_KernGetIsrId) @06c27e00
  Type: function definition analyzed
  Visibility: externally_visible public
  References: OS_kernelData/1 (read)OS_permittedContext/2 (read)OS_kernelData/1 (read)OS_permittedContext/2 (read)OS_configMode/3 (read)OS_svc_GetIsrId/5 (addr)OS_iecMode/6 (read)OS_kernelData/1 (read)OS_kernelData/1 (read)OS_configMode/3 (read)OS_svc_GetIsrId/5 (addr)OS_kernelData/1 (read)
  Referring: 
...
;; Function OS_KernGetIsrId (OS_KernGetIsrId, funcdef_no=0, decl_uid=7239, cgraph_uid=1, symbol_order=0)

Modification phase of node OS_KernGetIsrId/0
