...
OS_nAlarms/6 (OS_nAlarms) @06c49990
  Type: variable
...
OS_KernSetAbsAlarm/4 (OS_KernSetAbsAlarm) @06c6cc40
  ...
  Calls: 
OS_autoStartAlarms/3 (OS_autoStartAlarms) @06c498b8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_startModeAlarms/2 (OS_startModeAlarms) @06c49870
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
OS_appMode/1 (OS_appMode) @06c49828
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
