...
Jump functions:
  Jump functions of caller  CanSM_CtrlIdxFromCtrlId/8:
  Jump functions of caller  CanSM_NwIdxFromCtrlId/7:
  Jump functions of caller  CanSM_NwIdxFromTrcvId/6:
  Jump functions of caller  CanSM_NetworkHandleIsValid/5:
  Jump functions of caller  CanSM_GetNetworkHandleFromIndex/4:
  Jump functions of caller  CanSM_GetNetworkIndexFromHandle/3:

 Propagating constants:

Not considering CanSM_CtrlIdxFromCtrlId for cloning; -fipa-cp-clone disabled.
Not considering CanSM_NwIdxFromCtrlId for cloning; -fipa-cp-clone disabled.
Not considering CanSM_NwIdxFromTrcvId for cloning; -fipa-cp-clone disabled.
Not considering CanSM_NetworkHandleIsValid for cloning; -fipa-cp-clone disabled.
Not considering CanSM_GetNetworkHandleFromIndex for cloning; -fipa-cp-clone disabled.
Not considering CanSM_GetNetworkIndexFromHandle for cloning; -fipa-cp-clone disabled.
...
Lattices:
  Node: CanSM_CtrlIdxFromCtrlId/8:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         VARYING
        AGGS BOTTOM
  Node: CanSM_NwIdxFromCtrlId/7:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         VARYING
        AGGS BOTTOM
  Node: CanSM_NwIdxFromTrcvId/6:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         VARYING
        AGGS BOTTOM
  Node: CanSM_NetworkHandleIsValid/5:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         VARYING
        AGGS BOTTOM
  Node: CanSM_GetNetworkHandleFromIndex/4:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         VARYING
        AGGS BOTTOM
  Node: CanSM_GetNetworkIndexFromHandle/3:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         VARYING
...
;; Function CanSM_GetNetworkIndexFromHandle (CanSM_GetNetworkIndexFromHandle, funcdef_no=0, decl_uid=9431, cgraph_uid=1, symbol_order=3)

Modification phase of node CanSM_GetNetworkIndexFromHandle/3
...
;; Function CanSM_GetNetworkHandleFromIndex (CanSM_GetNetworkHandleFromIndex, funcdef_no=1, decl_uid=9433, cgraph_uid=2, symbol_order=4)

Modification phase of node CanSM_GetNetworkHandleFromIndex/4
...
;; Function CanSM_NetworkHandleIsValid (CanSM_NetworkHandleIsValid, funcdef_no=2, decl_uid=9435, cgraph_uid=3, symbol_order=5)

Modification phase of node CanSM_NetworkHandleIsValid/5
...
;; Function CanSM_NwIdxFromTrcvId (CanSM_NwIdxFromTrcvId, funcdef_no=3, decl_uid=9437, cgraph_uid=4, symbol_order=6)

Modification phase of node CanSM_NwIdxFromTrcvId/6
...
;; Function CanSM_NwIdxFromCtrlId (CanSM_NwIdxFromCtrlId, funcdef_no=4, decl_uid=9439, cgraph_uid=5, symbol_order=7)

Modification phase of node CanSM_NwIdxFromCtrlId/7
...
;; Function CanSM_CtrlIdxFromCtrlId (CanSM_CtrlIdxFromCtrlId, funcdef_no=5, decl_uid=9441, cgraph_uid=6, symbol_order=8)

Modification phase of node CanSM_CtrlIdxFromCtrlId/8
