...
ComM_ConstConfigLayoutType ComM_Configuration = {
    { /* RootCfg */
        ...
        UINT32_C( 286472449 ), /* CfgSignature */
    ...
    { /* aUsersOfAllChannel */
        UINT8_C( 255 ) /* aUsersOfAllChannel[0] */
    },
    { /* aChannelsOfAllUser */
        UINT8_C( 255 ) /* aChannelsOfAllUser[0] */
    }
};
